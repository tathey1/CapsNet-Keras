...
def CapsNet(input_shape, n_class, routings):
    ...
    conv3 = layers.Conv2D(filters=256, kernel_size=6, strides=2, padding='valid',
                          activation='relu', name='conv2')(conv2)
    conv4 = layers.Conv2D(filters=256, kernel_size=6, strides=2, padding='valid',
                          activation='relu', name='conv2')(conv3)
    conv5 = layers.Conv2D(filters=256, kernel_size=8, strides=2, padding='valid',
                          activation='relu', name='conv2')(conv4)

    # Layer 2: Conv2D layer with `squash` activation, then reshape to [None, num_capsule, dim_capsule]
    primarycaps = PrimaryCap(conv1, dim_capsule=8, n_channels=3872, kernel_size=9, strides=2, padding='valid')
