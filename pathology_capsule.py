...
if __name__ == "__main__":
    ...
    # load data
    (x_train, y_train_col), (x_test, y_test_col), label_to_class = pathology.load_data()
    ...
    y_train = np.zeros((y_train_col.shape[0],np.amax(y_train_col)+1))
    y_train[np.arange(y_train.shape[0]),y_train_col] = 1
    y_test = np.zeros((y_test_col.shape[0],np.amax(y_test_col)+1))
    y_test[np.arange(y_test.shape[0]),y_test_col] = 1
